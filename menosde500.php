...
<body>
    ...
    <nav class="navbar ba fixed-top ">
        <div class="container-fluid">
            ...
            <a class="navbar-brand tienda" href="vercarrito.php">VER Carrito</a>
...
$datos="SELECT * FROM ropa WHERE precio $comodin";


$carga=mysqli_query($conexion,$datos);
if($_GET["id"]==" < 500"){$c=" con precio menor a $ 500";}
if($_GET["id"]==" >500 AND precio<2000"){$c=" con precio mayor a $ 500 y menor a $ 2000";}
if($_GET["id"]==" >2000 AND precio<4000"){$c=" con precio mayor a $ 2000 y menor a $ 4000";}
if($_GET["id"]==" >4000 AND precio<7000"){$c=" con precio mayor a $ 4000 y menor a $ 7000";}
...
?>
            ...
            <div>
                <p class="h2">Elegiste ver prendas <?php echo $c;?></p>
            </div>
            <div class="boton">
                <div class="lui">
    ...
    ?>
            <div class="card c" style="width: 16rem; margin:auto">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title btn btn-primary c">
                        <?php 
...
?>
                    ...
                    <a href="detalles1.php? id=<?php echo $fila['id']?>" class="btn btn-primary c ">Detalles de
                        producto</a>
                    <div class="bot">
