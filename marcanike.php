...
$datos="SELECT * FROM ropa WHERE marca = 'nike'";
$carga=mysqli_query($conexion,$datos);
$cont=0;
?><div>
                <p class="h2">Elegiste ver ropa NIKE</p>
            </div>
            <div class="boton">
                <div class="lui">
                    ...
                    <button type="button" class="btn btn-success lui"><a class="btn btn-success" href="marcaadidas.php">
                            Ver adidas</a></button>
                </div>
                <div class="lui">
